...
class TimelineEventType(StrEnum):
    ...
    #: docs/adr/0023 (Incident Response Agent) — recorded once per
    #: `core.incident_response.models.IncidentResponsePlan` generated by
    #: `core/services/case_service.py`.
    INCIDENT_RESPONSE_PLAN_GENERATED = "incident_response_plan_generated"
    #: docs/adr/0024 (Report Generator Agent) — recorded once per
    #: `core.reporting.models.GeneratedReport` generated by
    #: `core/services/case_service.py`.
